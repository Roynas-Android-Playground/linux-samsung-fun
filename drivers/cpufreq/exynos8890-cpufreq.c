...
static const struct exynos8890_bus_lock mongoose_bus_locks[] = {
	...
	CPU_BUS_LOCK(2600000, 1794000), CPU_BUS_LOCK(2496000, 1794000),
	CPU_BUS_LOCK(2392000, 1794000), CPU_BUS_LOCK(2288000, 1794000),
	CPU_BUS_LOCK(2184000, 1794000), CPU_BUS_LOCK(2080000, 1794000),
	CPU_BUS_LOCK(1976000, 1539000), CPU_BUS_LOCK(1872000, 1352000),
	...
	CPU_BUS_LOCK(728000, 0), CPU_BUS_LOCK(624000, 0),
