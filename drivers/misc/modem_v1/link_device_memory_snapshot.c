...
{
	msb_kmem_cache =
		kmem_cache_create("msb_kmem_cache", sizeof(struct mst_buff), 0,
...
static inline void __msb_insert(struct mst_buff *msb, struct mst_buff *prev,
