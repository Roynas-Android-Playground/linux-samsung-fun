...
// clk-exynos8890.c's CCF driver also owns these CMU blocks - see commit for the dual-write story
static u8 cam_isp_dedup_scratch[SZ_64K] __aligned(SZ_64K);
#define DEFINE_V2P_SCRATCH(v)	\
	[v >> 16] = {	.pa = 0,	.ma = cam_isp_dedup_scratch,	}

// PERIS too; NOTE: S5E8890-syspwr.c's S2R save-restore table touches these offsets too, unaffected today since S2R isn't wired up
struct v2p_sfr v2psfrmap[] = {
	DEFINE_V2P_SCRATCH(CMU_PERIS_BASE),
	...
	DEFINE_V2P_SCRATCH(CMU_CAM0_BASE),
	DEFINE_V2P(CMU_CAM1_LOCAL_BASE,	0x141F0000),
	DEFINE_V2P_SCRATCH(CMU_CAM1_BASE),
	DEFINE_V2P(CMU_ISP0_LOCAL_BASE,	0x14290000),
	DEFINE_V2P_SCRATCH(CMU_ISP0_BASE),
	DEFINE_V2P(CMU_ISP1_LOCAL_BASE,	0x142F0000),
	DEFINE_V2P_SCRATCH(CMU_ISP1_BASE),
