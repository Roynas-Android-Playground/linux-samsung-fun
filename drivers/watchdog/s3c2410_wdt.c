...
// bit 24, not exynos7's 23 - confirmed against vendor's drv_data_exynos8 (Cronos_8890)
static const struct s3c2410_wdt_variant drv_data_exynos8890 = {
	.disable_reg = EXYNOS5_WDT_DISABLE_REG_OFFSET,
	.mask_reset_reg = EXYNOS5_WDT_MASK_RESET_REG_OFFSET,
	.mask_bit = 24,
	.rst_stat_reg = EXYNOS5_RST_STAT_REG_OFFSET,
	.rst_stat_bit = 24,	/* A53 (Apollo cluster) WDTRESET */
	.quirks = QUIRK_HAS_WTCLRINT_REG | QUIRK_HAS_PMU_MASK_RESET | \
		  QUIRK_HAS_PMU_RST_STAT | QUIRK_HAS_PMU_AUTO_DISABLE,
};
...
static const struct of_device_id s3c2410_wdt_match[] = {
	...
	{ .compatible = "samsung,exynos8890-wdt",
