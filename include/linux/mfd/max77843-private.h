...
/* The AFC receive buffer is HVRXBYTE1..HVRXBYTE16 */
#define MAX77843_MUIC_HVRXBYTE_MAX		16
...
#define MAX77843_MUIC_HVCONTROL1_DPDNVDEN_SHIFT	0
#define MAX77843_MUIC_HVCONTROL1_DNVD_SHIFT	1
#define MAX77843_MUIC_HVCONTROL1_DPVD_SHIFT	3
#define MAX77843_MUIC_HVCONTROL1_VBUSADCEN_SHIFT 5
#define MAX77843_MUIC_HVCONTROL1_DPDNVDEN_MASK	BIT(MAX77843_MUIC_HVCONTROL1_DPDNVDEN_SHIFT)
#define MAX77843_MUIC_HVCONTROL1_DNVD_MASK	(0x3 << MAX77843_MUIC_HVCONTROL1_DNVD_SHIFT)
#define MAX77843_MUIC_HVCONTROL1_DPVD_MASK	(0x3 << MAX77843_MUIC_HVCONTROL1_DPVD_SHIFT)
#define MAX77843_MUIC_HVCONTROL1_VBUSADCEN_MASK	BIT(MAX77843_MUIC_HVCONTROL1_VBUSADCEN_SHIFT)
/* DPVD drives D+ to 0.6V, which is what starts an AFC exchange */
#define MAX77843_MUIC_HVCONTROL1_DPVD_0_6V	(0x2 << MAX77843_MUIC_HVCONTROL1_DPVD_SHIFT)

/* MAX77843_MUIC_REG_HVCONTROL2 */
#define MAX77843_MUIC_HVCONTROL2_HVDIGEN_SHIFT	0
#define MAX77843_MUIC_HVCONTROL2_DP06EN_SHIFT	1
#define MAX77843_MUIC_HVCONTROL2_DNRESEN_SHIFT	2
#define MAX77843_MUIC_HVCONTROL2_MPING_SHIFT	3
#define MAX77843_MUIC_HVCONTROL2_MTXEN_SHIFT	4
#define MAX77843_MUIC_HVCONTROL2_MTXBUSRES_SHIFT 5
#define MAX77843_MUIC_HVCONTROL2_MPNGENB_SHIFT	6
#define MAX77843_MUIC_HVCONTROL2_HVDIGEN_MASK	BIT(MAX77843_MUIC_HVCONTROL2_HVDIGEN_SHIFT)
#define MAX77843_MUIC_HVCONTROL2_DP06EN_MASK	BIT(MAX77843_MUIC_HVCONTROL2_DP06EN_SHIFT)
#define MAX77843_MUIC_HVCONTROL2_DNRESEN_MASK	BIT(MAX77843_MUIC_HVCONTROL2_DNRESEN_SHIFT)
#define MAX77843_MUIC_HVCONTROL2_MPING_MASK	BIT(MAX77843_MUIC_HVCONTROL2_MPING_SHIFT)
#define MAX77843_MUIC_HVCONTROL2_MTXEN_MASK	BIT(MAX77843_MUIC_HVCONTROL2_MTXEN_SHIFT)
#define MAX77843_MUIC_HVCONTROL2_MTXBUSRES_MASK	BIT(MAX77843_MUIC_HVCONTROL2_MTXBUSRES_SHIFT)
#define MAX77843_MUIC_HVCONTROL2_MPNGENB_MASK	BIT(MAX77843_MUIC_HVCONTROL2_MPNGENB_SHIFT)

/* MAX77843_MUIC_REG_STATUS3 VBADC buckets */
#define MAX77843_MUIC_VBADC_VBDET		0x0
#define MAX77843_MUIC_VBADC_4V_5V		0x1
#define MAX77843_MUIC_VBADC_5V_6V		0x2
#define MAX77843_MUIC_VBADC_6V_7V		0x3
#define MAX77843_MUIC_VBADC_7V_8V		0x4
#define MAX77843_MUIC_VBADC_8V_9V		0x5
#define MAX77843_MUIC_VBADC_9V_10V		0x6
#define MAX77843_MUIC_VBADC_10V_12V		0x7
