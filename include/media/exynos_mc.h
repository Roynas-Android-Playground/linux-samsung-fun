...
static int dummy_callback(struct device *dev, const void *md)
{
...
static inline void entity_info_print(struct media_entity *me, struct device *dev)
{
	...
	/* me->links is a struct list_head of struct media_link since
	 * mainline media-entity.c replaced the old fixed link array. */
