...
/*
 * Vendor's copy also pulled in <linux/exynos_mfc_media.h> (the MFC video
 * codec's own 480-line uapi header) here, but nothing in this port uses
 * anything from it - only the NV12N/YUV420N macros below, which are
 * self-contained. Not porting the whole MFC subsystem for one unused
 * transitive include.
 */
